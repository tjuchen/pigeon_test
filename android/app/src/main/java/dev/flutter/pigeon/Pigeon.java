...
public class Pigeon {
  ...
  public interface Api {
    SearchReply searchReply(SearchRequest arg);
    ...
    static void setup(BinaryMessenger binaryMessenger, Api api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api.searchReply", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              SearchReply output = api.searchReply(input);
